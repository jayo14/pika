...
class Settings(BaseSettings):
    ...
    @property
    def email_missing_configuration(self) -> list[str]:
        required = {"SMTP_HOST": self.smtp_host, "SMTP_FROM_EMAIL": self.smtp_from_email}
        return [name for name, value in required.items() if not value]

    @property
    def email_ready(self) -> bool:
        return not self.email_missing_configuration
